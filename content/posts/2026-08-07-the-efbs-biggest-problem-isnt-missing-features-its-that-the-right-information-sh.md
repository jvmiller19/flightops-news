...
<cite index="18-7,18-8">The release also adds VFR Visual Approaches for runway-specific arrival planning, and Turn-Aware Flight Plans that present a more natural view of how a route will unfold in flight, with smoother speed-aware turn paths. These aren't headline-grabbing AI announcements, but they reflect the same underlying design logic: reduce the gap between what the system knows and what the pilot can actually act on in the moment.
