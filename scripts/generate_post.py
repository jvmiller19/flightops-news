...
THEME = (
    ...
    "TODAY ONLY — do not write about ForeFlight, Jeppesen ForeFlight, "
    "or the Airbus/Mistral AI partnership (both were already covered in "
    "recent posts); pick a completely different in-scope topic. "
