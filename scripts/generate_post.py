...
THEME = (
    ...
    "optimization, next-generation aviation software, airline data platforms, "
    ...
    "COCKPIT-FIRST PRIORITY — when choosing between topics, strongly prefer "
    "solutions and innovations that affect the cockpit and flightdeck "
    "(EFB platforms, flight planning tools, digital cockpit/avionics "
    "software, pilot-facing data and AI tools, navigation technology) over "
    "pure dispatch or OCC-centric stories. Dispatch/OCC transformation is "
    "still in scope but should not be the default — reach for the cockpit "
    "angle first. If a story touches both cockpit and OCC, frame it from "
    "the cockpit/pilot perspective. "
    ...
    "wifi, entertainment systems, or cabin experience; PSS (passenger "
    "service system) vendors and reservations/booking/e-commerce "
    "technology (e.g. Amadeus, Sabre, Travelport, Navitaire) and their "
    "platform competition, EVEN IF the story frames it as touching "
    ...
    "UNTIL 2026-08-24 — do not write about ForeFlight or Jeppesen "
    "ForeFlight; pick a different in-scope topic. "
    "TODAY ONLY — do not write about the Airbus/Mistral AI partnership "
    "(already covered in a recent post); pick a different in-scope topic. "
    ...
    "or any story where the primary subject is a physical device or "
    "equipment contract rather than a software platform or data capability. "
    "If your research surfaces a "
    "story in one of the out-of-scope areas, discard it and search again "
    "for something in scope rather than writing about it. "
