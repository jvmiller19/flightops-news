...
THEME = (
    ...
    "is out of scope regardless of framing; eVTOL and advanced air "
    "mobility (TODAY ONLY — skip this topic for today's post, pick "
    "something else in scope); avionics hardware integration stories "
    "(TODAY ONLY — skip pure avionics integration angles, pick "
